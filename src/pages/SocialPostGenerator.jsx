      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "32px 24px" }}>
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 14, color: "#555", marginTop: 6 }}>
            Generate ready-to-post graphics for Instagram, Facebook, LinkedIn, and more
          </p>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "420px 1fr", gap: 28, alignItems: "start" }}>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                {ASPECT_RATIOS.map(({ id, label }) => (
                  <button
                    ...
                    style={{
                      flex: 1, padding: "7px 0", borderRadius: 8, fontSize: 12, fontWeight: 700, cursor: "pointer",
                      border: aspectRatio === id ? "none" : "1px solid rgba(255,255,255,0.1)",
                      background: aspectRatio === id ? "#7c5cfc" : "transparent",
                      color: aspectRatio === id ? "#fff" : "#666",
                    }}
                  >
                    {label}
                  </button>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12, alignItems: "center" }}>
            <div style={{
              width: "100%", maxWidth: resultMaxW, aspectRatio: resultRatio,
              background: "#111118",
        ...
        <div style={{ marginTop: 48 }}>
          {history.length === 0 ? (
            <div style={{ fontSize: 13, color: "#333", textAlign: "center", padding: "20px 0" }}>
              No posts yet. Generate your first social media post.
            </div>
          ) : (
            <>
