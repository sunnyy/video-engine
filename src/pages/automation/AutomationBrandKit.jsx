...
export default function AutomationBrandKit() {
  ...
  if (loaded && !isProPlus) return <UpgradeGate feature="Brand Kit" blurb="The Brand Kit — your logo + CTA auto-applied to generated videos — is available on the Pro and Max plans." />;
  return (
