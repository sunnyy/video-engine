...
- SPLITS / COMPARISONS / "A, B, C or D" MOMENTS ARE MULTI-ASSET — a split-screen, an "X vs Y", a before→after, or a "what drains you: sleep, work, phone…" moment must be SEVERAL assets (one real image per side/option) that the designer composes, NEVER a single "split-screen" or "four-panel" ai_image (the generator bakes a messy grid). If the writer's content or visual_concept implies multiple things shown together, list one asset per thing.
