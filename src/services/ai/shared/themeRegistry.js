...
export const THEME_OPTIONS = [
  { id: "auto", label: "Auto", desc: "Let the topic decide", colors: ["#8896a8", "#38bdf8"] },
 ...
 */
export function resolveThemePalette(theme, accentColor) {
...
export function themeDirective(theme, accentColor) {
  const t = THEMES[theme];
  if (!t) return "";
  const accent = accentColor || t.defaultAccent;
