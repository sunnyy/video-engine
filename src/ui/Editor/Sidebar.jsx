...
export default function Sidebar({ activeTab, setActiveTab }) {
  ...
  const Item = ({ id, label }) => {
    ...
    return (
      <button
        ...
        className={`w-full text-[14px] font-semibold uppercase tracking-[0.08em] px-2 py-[20px] rounded-[6px] border transition cursor-pointer ${
          active
  ...
  return (
    ...
    <div className="w-[110px] border-r border-[rgba(255,255,255,0.06)] bg-black p-4 flex flex-col gap-3">
