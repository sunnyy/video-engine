...

  {
    ...
    zones: [
      { id:"z1", type:"text", role:"headline", maxChars:28, order:1, x:5, y:5, width:90, height:14, zIndex:3, start:0, end:null,
        enterAnimation:"slideDownIn", exitAnimation:"none",
        style:{ fontSize:88, fontWeight:900, color:"#ffffff", textAlign:"center", textShadow:"0 4px 24px rgba(0,0,0,0.9)", lineHeight:1.05 } },
      { id:"z2", type:"decorative", role:"decorative", order:1, x:2, y:24, width:4, height:46, zIndex:3, start:0, end:null,
        enterAnimation:"fadeIn", exitAnimation:"none",
        style:{ borderRadius:4, opacity:1 } },
      { id:"z3", type:"asset", role:"primary_asset", order:1, x:10, y:24, width:68, height:46, zIndex:2, start:0.2, end:null,
        enterAnimation:"fadeIn", exitAnimation:"none",
        style:{ objectFit:"cover", borderRadius:16 } },
      { id:"z4", type:"decorative", role:"decorative", order:2, x:94, y:24, width:4, height:46, zIndex:3, start:0, end:null,
        enterAnimation:"fadeIn", exitAnimation:"none",
        style:{ borderRadius:4, opacity:1 } },
      { id:"z5", type:"icon", role:"icon", order:1, x:72, y:56, width:16, height:11, zIndex:4, start:0.3, end:null,
        enterAnimation:"popIn", exitAnimation:"none",
        style:{ opacity:1, borderRadius:999 } },
      { id:"z6", type:"text", role:"subtext", maxChars:45, order:2, x:5, y:83, width:90, height:10, zIndex:3, start:0.4, end:null,
        enterAnimation:"slideUpIn", exitAnimation:"none",
        style:{ fontSize:52, fontWeight:500, color:"#ffffff", textAlign:"center", opacity:0.85 } },
    ],
  },
