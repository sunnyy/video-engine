 ...
 * reserved for Pro and Max. This is the HARD enforcement — the landing copy is just marketing.
...
/** The slug of the user's active plan ("starter" | "pro" | "max"), or null if none. */
...
/** Express middleware: allow only Pro/Max (or admins). `feature` is used in the 403 message. */
  ...
  return async (req, res, next) => {
    try {
      ...
      return res.status(403).json({
        error: `${feature} is available on the Pro and Max plans. Upgrade to unlock it.`,
