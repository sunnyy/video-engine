export function getInstagramPostPrompt({ headline, subtext, brandName, niche, style, aspectRatio, hasReferenceImage }) {
  const textBlock = [
  ...
  const ratioDesc = aspectRatio === "1:1" ? "1:1 square format" : "4:5 portrait format (1080x1350px)";
...
Create a detailed image generation prompt for a ${ratioDesc} Instagram post for the ${niche} niche.
...
2. Generate a single comprehensive image generation prompt that will produce a professional Instagram post
